package Project.Classes.Services;
import Project.Classes.Comparator.ProductComparator;
import Project.Classes.Stores.Adress;
import Project.Classes.Stores.Orders.Card;
import Project.Classes.Stores.Orders.Order;
import Project.Classes.Stores.Products.Accessory;
import Project.Classes.Stores.Products.Instrument;
import Project.Classes.Stores.Products.Product;
import Project.Classes.Stores.Products.Review;
import Project.Classes.Stores.Store;
import Project.Classes.Stores.Voucher;
...
public class Services {
    ...
    private void checkIfIdExistInStores(UUID id) throws IOException{
        boolean check = false;
        for(Pair<Store,ArrayList<Product>> pair : storeWithProductsList) {
